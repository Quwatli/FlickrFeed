...
//implementing the interface OnDownloadComplete has the purpose of making sure the GetRawData downloading class gets the correct object that has an OnDownloadComplete method
...
public class MainActivity extends AppCompatActivity implements OnDownloadComplete {
    ...
    public void onDownloadComplete(String data, DownloadStatus status) {
        if (status == DownloadStatus.OK) {
            ...
            Log.e(TAG, "onDownloadComplete: Error downloading or processing the request, status returned: " + status);
        }
    }
}
